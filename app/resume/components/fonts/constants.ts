 ...
 *         a. Registering font family for React PDF at "@/app/resume/components/fonts/hooks.tsx"
 *         b. Loading font family for React PDF iframe at "@/app/resume/components/Resume/ResumeIFrame.tsx"
 *         c. Adding font family selection to Resume Settings at "@/app/resume/components/ResumeForm/ThemeForm/Selection.tsx"
 * Step 2. To load css correctly for the Resume Form:
 *         English fonts -> add it to the "public\fonts\fonts.css" file
 *         Non-English fonts -> create/update "public\fonts\fonts-<language>.css" and update "@/app/resume/components/fonts/NonEnglishFontsCSSLazyLoader.tsx"
