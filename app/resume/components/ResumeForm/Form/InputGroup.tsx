...
import { useAutosizeTextareaHeight } from "@/app/resume/lib/hooks/useAutosizeTextareaHeight";
...
export const InputGroupWrapper = ({
  ...
  <label className={`text-xs font-bold uppercase tracking-wider text-slate-500 mb-1.5 block ${className}`}>
    {label}
    {children}
  </label>
);
...
export const INPUT_CLASS_NAME =
  "mt-1.5 px-4 py-2.5 block w-full rounded-lg border-0 bg-slate-50 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-slate-900 text-sm sm:leading-6 transition-all duration-200 outline-none antialiased hover:bg-slate-100/50";
