import { BULLET_POINTS } from "@/app/resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points";
import { isBold } from "@/app/resume/lib/parse-resume-from-pdf/extract-resume-from-sections/lib/common-features";
import type { Lines, Line, Subsections } from "@/app/resume/lib/parse-resume-from-pdf/types";
